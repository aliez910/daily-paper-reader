...
tags: ["query:rob-il"]
score: 8.0
evidence: 从视频中进行人到机器人动作迁移的以物体为中心的框架
...
motivation: 旨在解决如何从人类演示视频中高效、鲁棒地学习机器人操纵技能，并克服单一视觉模态在感知物体属性方面的局限性。
method: 结合3D基础模型重建物体中心点云，并引入大规模触觉先验，通过多模态融合模块与扩散策略生成操作指令。
result: 在纯视觉和视触觉任务的广泛实验中，OCRA的性能显著优于现有基线模型和消融实验。
conclusion: 证明了结合3D视觉与触觉先验的以物体为中心的方法，是实现从人类视频到机器人动作迁移的有效途径。
---
