...
tags: ["query:rob-il"]
score: 8.0
evidence: 通过代码生成的机器人操纵多模态语言模型
tldr: 本研究提出Act-Observe-Rewrite (AOR)框架，旨在探索多模态大模型在无需梯度更新、演示或奖励工程的情况下，能否通过反思失败来学习机器人操作。AOR将低级电机控制代码作为推理单元，使LLM能根据视觉观察和任务结果，在尝试间隙重写Python控制器代码。该方法利用代码的可解释性实现上下文策略学习，显著提升了机器人在复杂任务中的自主改进能力。
