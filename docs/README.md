...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-08 19:58:56 UTC<br>状态：成功</p>
</section>
...
<p>精读：《PAVE: Predictive Alignment and Value-Guided Evolution for World-Action Policies》（9.0/10）, 《REFACTOR-VLA: Unsupervised Library Learning of Typed Motor Programs》（9.0/10）</p>
<p>速读：《Motus2: A Self-Evolving General World Model for Dexterous Manipulation》（8.0/10）, 《CometVLA: Co-Training on an Embodied Data Pyramid towards Physical Understanding》（8.0/10）, 《Behavior-Skill: A Fine-Grained Benchmark for Evaluating Vision-Language-Action Policies in Long-Horizon Tasks》（8.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="PAVE: Predictive Alignment and Value-Guided Evolution for World-Action Policies">PAVE: Predictive Alignment and Value-Guided Evolution for World-Action Policies</span></li><li><span class="dpr-home-dashboard-paper-title" title="REFACTOR-VLA: Unsupervised Library Learning of Typed Motor Programs">REFACTOR-VLA: Unsupervised Library Learning of Typed Motor Programs</span></li><li><span class="dpr-home-dashboard-paper-title" title="Does Imitation Learning Preserve Temporal Robustness in Dexterous Manipulation? An Expert-Learner Comparison Across Task Execution Speeds">Does Imitation Learning Preserve Temporal Robustness in Dexterous Manipulation? An Expert-Learner Comparison Across Task Execution Speeds</span></li></ul>
  </div>
