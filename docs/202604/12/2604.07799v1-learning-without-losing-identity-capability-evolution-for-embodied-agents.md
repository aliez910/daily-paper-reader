...
tldr: 针对具身智能体在长期运行中因频繁修改自身导致身份丢失和不稳定的问题，本文提出一种以能力为中心的演化范式。通过引入具身能力模块（ECM），将能力演化与智能体身份解耦。该框架通过闭环学习不断优化模块，在显著提升任务成功率的同时确保了系统的稳定性和安全性，为构建长效具身智能提供了新思路。
selection_source: fresh_fetch
motivation: 现有的智能体改进方法通过修改智能体本身来实现，导致长期运行系统出现不稳定性、身份丢失及安全风险。
