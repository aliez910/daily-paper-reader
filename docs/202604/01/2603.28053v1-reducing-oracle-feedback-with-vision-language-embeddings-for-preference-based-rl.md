...
tldr: "针对基于偏好的强化学习（PbRL）中专家反馈成本高昂的问题，本文提出了ROVED框架。该框架结合了视觉语言嵌入（VLE）模型与针对性的专家反馈，利用VLE生成初步偏好，并仅在不确定性高时请求专家标注。通过参数高效微调，VLE能利用专家反馈不断进化。实验表明，ROVED在多种机器人任务中将专家查询量减少了80%-90%，同时保持或超越了现有方法的性能。"
