...
tags: ["query:rob-il"]
score: 6.0
evidence: 评估VLM在机器人运动规划和空间推理中的表现
...
motivation: 旨在探究视觉语言模型是否具备处理机器人运动中复杂空间推理及用户运动偏好约束的能力。
method: 采用四种不同的查询方法，对四种最先进的视觉语言模型在物体接近度和路径风格等运动偏好任务上进行了评估。
result: "实验显示Qwen2.5-VL在零样本测试中达到71.4%的准确率，且在微调后进一步提升，表现优于GPT-4o。"
conclusion: 研究证明了视觉语言模型在机器人运动规划中具有集成潜力，能够有效处理空间推理和运动偏好。
---
